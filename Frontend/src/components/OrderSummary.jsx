...
"pk_test_51RpWsP1iuu1Xwk7UkgHirdYztwEKWhAvSGCyKTlXGQxIk1Vo0bEiFM4OQ0Q3TzaP2Rsoqm9UDPDU8gAJGaJ3GXQW00YcRK9UO1")
				...
				<div className='space-y-2'>
					...
					{savings > 0 && (
						<dl className='flex items-center justify-between gap-4'>
							...
							<dd className='text-base font-medium text-violet-400'>-${formattedSavings}</dd>
						</dl>
					)}
					...
					{coupon && isCouponApplied && (
						<dl className='flex items-center justify-between gap-4'>
							...
							<dd className='text-base font-medium text-violet-400'>-{coupon.discountPercentage}%</dd>
						</dl>
					)}
					<dl className='flex items-center justify-between gap-4 border-t border-gray-600 pt-2'>
						<dt className='text-base font-bold text-white'>Total</dt>
						<dd className='text-base font-bold text-violet-400'>${formattedTotal}</dd>
					</dl>
				</div>
